...
export class FeatureFlagManager {
     ...
     */
    getValue(flagName, defaultValue, userId) {
     ...
     */
    createFlag(name, enabled, description, options) {
        const flag = {
            name,
            enabled,
            description,
...
export let featureFlagManager = null;
export function initializeFeatureFlags(config, environment) {
 ...
 */
export function getFeatureValue(flagName, defaultValue, userId) {
