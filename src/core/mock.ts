...
export class MockResponseProvider {
  ...
  private static getMockAccountResponse(toolName: string, params: any): CwpResponse {
    const baseAccount = {
  ...
  private static getMockPackageResponse(_toolName: string, _params: any): CwpResponse {
    const mockPackages = [
      {
        name: 'basic',
        quota: '1GB',
  ...
  private static getMockAutosslResponse(toolName: string, params: any): CwpResponse {
    const mockCerts = [
      {
  ...
  private static getMockFtpResponse(toolName: string, params: any): CwpResponse {
  ...
  private static getMockMysqlResponse(toolName: string, params: any): CwpResponse {
    const mockDatabases = [
      {
